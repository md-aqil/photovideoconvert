                ...
                <PageHeading>
                    ...
                    <PageHeading.Actions>
                        <Button asChild variant="outline">
                            <Link href={route("admin.topics.index")}>Cancel</Link>
                        </Button>
                        ...
                        >
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => {
                                        if(!topic) {
                                            setData({title: e.target.value, slug: textToSlug(e.target.value)});
                                        }
                                        else {
                            ...
                            <div>
                                ...
                                <RadioGroup defaultValue={true} name="activated_at" value={data.activated_at} onValueChange={(e) => setData('activated_at', e)} className="flex gap-x-4 ">
                                    <Label htmlFor="active" className="flex items-center space-x-2 bg-slate-100 p-2 w-full border rounded">
                                        <RadioGroupItem value={true} id="active" />
                                        <span>Active</span>
                                    </Label>
                                    <Label htmlFor="inactive" className="flex items-center space-x-2 bg-slate-100 p-2 w-full border rounded">
